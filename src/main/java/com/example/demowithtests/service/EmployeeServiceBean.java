...
public class EmployeeServiceBean implements EmployeeService {
    ...
    public EmployeeDto getById(Integer id) {
        ...
        if (employee.getIsDeleted() == null) {
            throw new EntityFieldIsDeletedIsNullException("Employee with id: " + id + " has isTest == null");
        } else if (employee.getIsDeleted()) {
            throw new EntityNotFoundException("User try to access to employee with id: " + id
